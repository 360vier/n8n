...
export type OnOfficeAction = 'get' | 'read' | 'modify' | 'create' | 'delete';
export type OnOfficeActionId = `urn:onoffice-de-ns:smart:2.5:smartml:action:${OnOfficeAction}`;
export type OnOfficeResource = 'estate' | 'address' | 'user' | 'fields' | 'searchcriterias' | 'searchCriteriaFields' | 'relation' | 'idsfromrelation' | 'actionkindtypes';
